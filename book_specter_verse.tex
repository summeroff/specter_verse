...
\usepackage[protrusion=true]{microtype} % Changed: removed expansion=true
\usepackage{csquotes}
\usepackage{hyperref}
\hypersetup{
    colorlinks=true,
...
\AtBeginDocument{\sloppy} % Added: relax line-breaking to reduce overfull hboxes

\begin{document}

% [Rest of your document, e.g., Chapter 9 content remains unchanged]
\begin{titlepage}
    \centering
    \vspace*{3cm}
